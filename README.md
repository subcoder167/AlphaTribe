...
## A Brief of the Prototype:
  ...
  That's what we explored in this project. We used this opportunity to test out the Intel Ai and Analytics toolkit library to help optimize and reduce the          runtime of each equation through numerous iterations. We were successfully able to reduce the run time by 400% in some cases.
